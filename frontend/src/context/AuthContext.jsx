...
const DEFAULT_SUPER_ADMIN = {
  ...
  email: "superadmin@videobelajar.com",
...
const getUsers = () => {
  try {
    ...
    if (Array.isArray(saved)) {
      ...
      if (!users.some((item) => item.email === DEFAULT_ADMIN.email)) users.push(DEFAULT_ADMIN);
      if (!users.some((item) => item.email === DEFAULT_SUPER_ADMIN.email)) users.push(DEFAULT_SUPER_ADMIN);
  ...
  const users = oldUser
    ...
    : [DEFAULT_ADMIN, DEFAULT_SUPER_ADMIN];
